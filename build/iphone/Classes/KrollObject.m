 ...
 * Copyright (c) 2009-2011 by GameTalkLive, Inc. All Rights Reserved.
...
//@interface GameTalkLiveObject : NSObject
//@end

@interface GameTalkLiveObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GameTalkLiveObject class]])
		{
			for (NSString *key in [[(GameTalkLiveObject*)o modules] allKeys])
			{
