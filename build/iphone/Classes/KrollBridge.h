...
@interface GameTalkLiveObject : KrollCoverageObject {
#else
@interface GameTalkLiveObject : KrollObject {
#endif
@private
...
extern NSString * GameTalkLive$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GameTalkLiveObject *_gametalklive;
	BOOL shutdown;
