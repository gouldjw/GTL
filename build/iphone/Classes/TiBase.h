...
// in simulator we redefine to format for GameTalkLive Developer console
...
{\
	NSString * exceptionName = [@"org.gametalklive." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gametalklive";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGameTalkLiveNativeItemNone = -1, 
	UIGameTalkLiveNativeItemSpinner = -2,
	UIGameTalkLiveNativeItemProgressBar = -3,
	
	UIGameTalkLiveNativeItemSlider = -4,
	UIGameTalkLiveNativeItemSwitch = -5,
	UIGameTalkLiveNativeItemMultiButton = -6,
	UIGameTalkLiveNativeItemSegmented = -7,
	
	UIGameTalkLiveNativeItemTextView = -8,
	UIGameTalkLiveNativeItemTextField = -9,
	UIGameTalkLiveNativeItemSearchBar = -10,
	
	UIGameTalkLiveNativeItemPicker = -11,
	UIGameTalkLiveNativeItemDatePicker = -12,
	
	UIGameTalkLiveNativeItemInfoLight = -13,
	UIGameTalkLiveNativeItemInfoDark = -14,
	
	UIGameTalkLiveNativeItemDisclosure = -15,
	
	UIGameTalkLiveNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all GameTalkLive instances of
